...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-sovereign-pnh-governance/security) of this repository.
...
This policy covers the `rayls-sovereign-pnh-governance` repository (the PNH governance API,
