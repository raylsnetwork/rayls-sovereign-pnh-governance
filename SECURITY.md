...
1. Open the [Security tab](https://github.com/raylsnetwork/rayls-privacy-pnh-governance-api/security) of this repository.
...
- The affected component(s) (`api` / `listener` / `flagger`), version(s), and configuration.
...
This policy covers the `rayls-privacy-pnh-governance-api` repository (the PNH governance API,
listener, and flagger services). Vulnerabilities in other Rayls components should be reported
